    ...
    public static class Common
    {
        ...
        public static string GetAppPath
        {
            get
            {
                ...
                else if (HttpContext.Current.Request.Url.Port != null && HttpContext.Current.Request.Url.Port > 0)
                {
        ...
        public static string SendMessage(string DeviceToken, string Title, string Message)
        {
            string serverKey = "AAAAbGVoYQM:APA91bH7LcBOeX8tcmFafNXkml1DKpf7Qvg4DdDVFWSPDp8qaT1duvZxbW_P5imXLvVvskzgRtmUloxDzLa1pvKIVtDgF6BakPNmvydKDa2CbD2k-1zF9kMXk4FbjraiyQjDEw1yZzPt";
            var result = "-1";
            try
            {
                ...
                {
                    string json = "{\"to\": \"" + DeviceToken + "\",\"data\": {\"title\": \"" + Title + "\", \"message\": \"" + Message + "\"}}";
