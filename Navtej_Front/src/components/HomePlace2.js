...
export default function HomePlace2(props) {
  ...
  let homeCategory1 = props.homeCategory.filter((category) => {
    return category.PlaceHolderIDForHome == 2;
  });
  let post0 = "";
      ...
      <section className="home-front-area">
        <div className="container">
          <div className="row">
                                ...
                                <div className="content-wrapper">
                                  ...
                                  <div className="tag" style={post && post.length > 0 ? { backgroundColor: post[0].CategoryColor } : { backgroundColor: '#9c27b0' }}>
                                    ...
                                    <img
                                      ...
                                      alt={post && post.length > 0 ? post[0].TitleData[0].Translation : ""}
                                      className="lazy"
                                    />
                                  </div>
                                  <div className="inner-content">
                                    <a href={`${configData.BASE_URL_CATEGORY_DETAIL}${post && post.length > 0 ? post[0].Slug : ''}`}>
                                      ...
                                      {post && post.length > 0 ? parse(
                                          post[0].DescriptionData[0].Translation.substring(0,175) + '...'
                                        ) : ''}
                                      </p>
                                    </a>
                                  </div>
            ...
            <HomePlace3 homeCategory={props.homeCategory} />
          </div>
        </div>
      </section>
    </Fragment>
