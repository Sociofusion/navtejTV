  ...
  , createToken: function (attrs, triggerChange) {
      ...
      var $token = $('<div class="token" />')
          ...
          .data('attrs', attrs)
                      ...
                      // Save in hiddenField Start Dc
                      var existTags = $("#hdnTags").val();
                      if (existTags != "")
                          existTags = existTags + ',' + attrs.value;
                      else
                          existTags = attrs.value;

                      $("#hdnTags").val(existTags);

                      // Save in hiddenField End Dc
